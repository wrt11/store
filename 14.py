...
wb = xlrd.open_workbook(filename=r"C:\Users\灵\Desktop\day14参数化测试/bank.xls",encoding_override=True)
...
def send_email(name):
    sender = '1371027409@qq.com'
    passwd = "mmrogrkaqlibbadg"
    receivers = '1371027409@qq.com'
    subject = '工商银行管理系统测试'
